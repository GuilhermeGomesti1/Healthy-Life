...
export const IconDicas = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      className={styles.iconDicas}
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
      viewBox="0 0 24 24"
